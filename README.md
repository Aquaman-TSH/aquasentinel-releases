...
### [⬇ Download the latest beta — v1.6.0-beta.3](https://github.com/Aquaman-TSH/aquasentinel-releases/releases/tag/v1.6.0-beta.3)
...
*More screenshots on the [latest release page](https://github.com/Aquaman-TSH/aquasentinel-releases/releases/tag/v1.6.0-beta.3).*
